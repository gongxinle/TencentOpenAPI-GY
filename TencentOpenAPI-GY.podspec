#
# Be sure to run `pod lib lint TencentOpenAPI-GY.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '3.5.14'
  s.summary          = 'TencentOpenAPI person pod. why doesn't tencent provide?'
